<html>
	...
	<body>
		...
		<form action="./questionarioController.php" class="contact1-form validate-form">
			<div class="contact1">
				<div class="container-contact1">
					...
					<div class="form-group">
						...
						<div class="wrap-input1 validate-input" data-validate = "Nome deve ser informado">
							<input id="txtNome" name="txtNome" type="text" class="input1"/>
							<span class="shadow-input1"></span>
						</div>
					</div>
					<div class="form-group">
						<label for="txtEmail">Email:</label>
						<input id="txtEmail" name="txtEmail" type="text" class="input1"/>
					</div>
					<div class="form-group">
						<div class="row">
							<div class="col-md-2">
